...
namespace Utils {
	...
	inline FontManagerGUI::FontListBox::FontListBox(FontManagerGUI* manager, HFONT font, HINSTANCE hInstance) : WindowBase(WS_EX_LTRREADING, WC_LISTBOX, WS_VISIBLE |
	...
	inline FontManagerGUI::FszGroupBox::FszGroupBox(FontManagerGUI* manager, HFONT font, HINSTANCE hInstance) : WindowBase(
	...
	inline FontManagerGUI::FszGroupBox::Editor::Editor(FontManagerGUI* manager, HWND parent, HFONT font, HINSTANCE hInstance): WindowBase(WS_EX_CLIENTEDGE,
	...
	inline FontManagerGUI::FszGroupBox::Trackbar::Trackbar(HWND parent, HINSTANCE hInstance): WindowBase(WS_EX_LTRREADING,
	...
	inline FontManagerGUI::FszGroupBox::SizeText::SizeText(HWND parent, HFONT font, HINSTANCE hInstance) : WindowBase(
	...
	inline FontManagerGUI::StyGroupBox::StyGroupBox(FontManagerGUI* manager, HFONT font, HINSTANCE hInstance): WindowBase(
	...
	auto FontManagerGUI::OnChanged(std::function<void(int size, Style style, const std::wstring_view name)> callback) -> FontManagerGUI& {
		return this->OnChanged([callback](const FontManagerGUI* m_this) -> void {
	...
	auto Utils::FontManagerGUI::ChooseFont(std::function<void(int size, Style style, const std::wstring_view name)> callback) -> FontManagerGUI& {
	...
	auto Utils::FontManagerGUI::MakeFont(DWORD iCharSet, int baseSize) const -> HFONT {
		...
		return ::CreateFontW(size + baseSize, 0, 0, 0, style & static_cast<uint16_t>(0x00F0) ? FW_BOLD : FW_NORMAL,
	...
	auto Utils::FontManagerGUI::MakeDefualtFont(DWORD iCharSet, int baseSize) const -> HFONT {
		return ::CreateFontW(this->defaultData.size + baseSize, 0, 0, 0, this->defaultData.style & static_cast<uint16_t>(0x00F0) ? FW_BOLD : FW_NORMAL,
	...
	auto FontManagerGUI::UpdateDisplay(bool state, SIZE size, PAINTSTRUCT ps) -> FontManagerGUI& {
	...
	auto FontManagerGUI::CreatePtr(HWND parent, HINSTANCE hInstance) -> std::unique_ptr<FontManagerGUI> {
		return FontManagerGUI::CreatePtr(parent, ::CreateFontW(20, 0, 0, 0, FW_NORMAL, FALSE, FALSE,
