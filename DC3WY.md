...
首先我们先到`x32dbg -> 符号`找到`dsound.dll`，然后右键`下载此模块的符号信息`<br> ![Image_text](https://raw.githubusercontent.com/cokkeijigen/circus_engine_patchs/master/Pictures/img_dc3wy_note_22.png)
