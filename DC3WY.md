...
如果通过`FontManagerGUI`更改字体大小时，会把这个`map`中的所有字体通过原始大小进行计算，获得缩放比例再更新并创建出与其大小相对新的`HFONT`对象(详细：
[Utils::FontManagerGUI::MakeFont](https://github.com/cokkeijigen/circus_engine_patchs/blob/8596e14272a66e891480e903526bf1d2fe93ff42/CircusEnginePatchs/utillibs/fontmanager/FontManagerGUI.cpp#L711)、
[Utils::FontManager::m_GUI::OnChanged](https://github.com/cokkeijigen/circus_engine_patchs/blob/8596e14272a66e891480e903526bf1d2fe93ff42/CircusEnginePatchs/utillibs/fontmanager/FontManager.cpp#L24)
),
